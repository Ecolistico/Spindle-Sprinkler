...
const float movePressMMSteps = (MotorSteps*moveMicroSteps)/PressMMRev;
const float SpindlesMMSteps = (MotorSteps*MicroSteps)/SpindlesMMRev;

const float Centralmm = 42;
const float Leftmm = 85;
const float Rightmm= 86;
...
void drill(){
  ...
  cerosSPc();
  int CentralSteps=Centralmm*SpindlesMMSteps;
  digitalWrite(enableSPc, LOW);
  digitalWrite(dirPinSPc, HIGH);
  ...
  cerosSPi();
  int LeftSteps=Leftmm*SpindlesMMSteps;
  digitalWrite(enableSPi, LOW);
  digitalWrite(dirPinSPi, HIGH);
  ...
  cerosSPd();
  int RightSteps=Rightmm*SpindlesMMSteps;
  digitalWrite(enableSPd, LOW);
  digitalWrite(dirPinSPd, HIGH);
